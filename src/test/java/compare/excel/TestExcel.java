...
public class TestExcel {
    ...
    public void test1 () {
        ...
        Workbook actualDoubleReport = null;
        Workbook expectedDoubleReport = null;
        try {
            ...
            actualDoubleReport = new HSSFWorkbook(new FileInputStream("C:\\Users\\gis\\IdeaProjects\\experi\\resources\\files\\excelToCompare\\Отчет 31.01.2019 (1).xls"));
            expectedDoubleReport = new HSSFWorkbook(new FileInputStream("C:\\Users\\gis\\IdeaProjects\\experi\\resources\\files\\excelToCompare\\Отчет 31.01.2019 (2).xls"));
        } catch (IOException e) {
            e.printStackTrace();
        }

        MatcherAssert.assertThat(actual, sameWorkbook(expected_1));
        MatcherAssert.assertThat(actualDoubleReport, sameWorkbook(expectedDoubleReport));
